...
*/
    ...
    typedef struct list_interface {
        ...
        void (*print)(list_t *list, void (*printdata)(any_t ), const char *sep);
    ...
    void list_print(list_t *list, void (*print_data)(any_t ), const char *sep);
    any_t *array_build(list_t *list);
    list_t *list_build(char **array);

    list_t *list_dup(list_t *list, any_t (*dup_data)(any_t ));
