...
Test(array_build, test_list_build)
{
    list_t *list = NULL;
    char **array = NULL;
...
Test(array_build, test_list_build_empty)
{
    list_t *list = NULL;
    char **array = NULL;
...
Test(array_build, test_list_build_null)
{
    char **array = NULL;
...
Test(chained_list_build, test_null)
{
    char **array = NULL;
    list_t *list = NULL;
...
Test(chained_list_build, test_tree)
{
    char **array = NULL;
    list_t *list = NULL;
    ...
    cr_assert_eq(list->head->next->next->next->data, "DATA4");
